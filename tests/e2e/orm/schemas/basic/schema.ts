        ...
        User: {
            ...
            fields: {
                ...
                role: {
                    name: "role",
                    type: "Role",
                    attributes: [{ name: "@default", args: [{ name: "value", value: ExpressionUtils.enum("Role", "USER") }] }],
                    default: "USER"
                },
                posts: {
                    name: "posts",
        ...
        Comment: {
            ...
            fields: {
                ...
                post: {
                    ...
                    type: "Post",
                    optional: true,
                    attributes: [{ name: "@relation", args: [{ name: "fields", value: ExpressionUtils.array([ExpressionUtils.field("postId")]) }, { name: "references", value: ExpressionUtils.array([ExpressionUtils.field("id")]) }, { name: "onUpdate", value: ExpressionUtils.enum("ReferentialAction", "Cascade") }, { name: "onDelete", value: ExpressionUtils.enum("ReferentialAction", "Cascade") }] }],
        ...
        Profile: {
            ...
            fields: {
                ...
                user: {
                    ...
                    type: "User",
                    optional: true,
                    attributes: [{ name: "@relation", args: [{ name: "fields", value: ExpressionUtils.array([ExpressionUtils.field("userId")]) }, { name: "references", value: ExpressionUtils.array([ExpressionUtils.field("id")]) }, { name: "onUpdate", value: ExpressionUtils.enum("ReferentialAction", "Cascade") }, { name: "onDelete", value: ExpressionUtils.enum("ReferentialAction", "Cascade") }] }],
