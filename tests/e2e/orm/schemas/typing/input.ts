...
export type RegionGetPayload<Args extends $SelectIncludeOmit<$Schema, "Region", true>, Options extends $QueryOptions<$Schema> = $QueryOptions<$Schema>> = $Result<$Schema, "Region", Args, Options>;
...
export type MetaGetPayload<Args extends $SelectIncludeOmit<$Schema, "Meta", true>, Options extends $QueryOptions<$Schema> = $QueryOptions<$Schema>> = $Result<$Schema, "Meta", Args, Options>;
