...
export type AssetGetPayload<Args extends $SelectIncludeOmit<$Schema, "Asset", true>, Options extends $ClientOptions<$Schema> = $ClientOptions<$Schema>> = $SimplifiedModelResult<$Schema, "Asset", Options, Args>;
...
export type RatedVideoGetPayload<Args extends $SelectIncludeOmit<$Schema, "RatedVideo", true>, Options extends $ClientOptions<$Schema> = $ClientOptions<$Schema>> = $SimplifiedModelResult<$Schema, "RatedVideo", Options, Args>;
...
export type GalleryGetPayload<Args extends $SelectIncludeOmit<$Schema, "Gallery", true>, Options extends $ClientOptions<$Schema> = $ClientOptions<$Schema>> = $SimplifiedModelResult<$Schema, "Gallery", Options, Args>;
