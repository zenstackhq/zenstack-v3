...
export type RegionGetPayload<Args extends $SelectIncludeOmit<$Schema, "Region", true>> = $SimplifiedModelResult<$Schema, "Region", Args>;
...
export type MetaGetPayload<Args extends $SelectIncludeOmit<$Schema, "Meta", true>> = $SimplifiedModelResult<$Schema, "Meta", Args>;
