...
export type BaseGetPayload<Args extends $SelectIncludeOmit<$Schema, "Base", true>, Options extends $ClientOptions<$Schema> = $ClientOptions<$Schema>> = $SimplifiedModelResult<$Schema, "Base", Options, Args>;
...
export type SubGetPayload<Args extends $SelectIncludeOmit<$Schema, "Sub", true>, Options extends $ClientOptions<$Schema> = $ClientOptions<$Schema>> = $SimplifiedModelResult<$Schema, "Sub", Options, Args>;
