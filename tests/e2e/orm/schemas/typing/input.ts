...
export type RegionGetPayload<Args extends $SelectIncludeOmit<$Schema, "Region", true>, Options extends $ClientOptions<$Schema> = $ClientOptions<$Schema>> = $SimplifiedModelResult<$Schema, "Region", Options, Args>;
...
export type MetaGetPayload<Args extends $SelectIncludeOmit<$Schema, "Meta", true>, Options extends $ClientOptions<$Schema> = $ClientOptions<$Schema>> = $SimplifiedModelResult<$Schema, "Meta", Options, Args>;
