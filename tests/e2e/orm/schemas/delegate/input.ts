...
export type AssetGetPayload<Args extends $SelectIncludeOmit<$Schema, "Asset", true>> = $SimplifiedModelResult<$Schema, "Asset", Args>;
...
export type RatedVideoGetPayload<Args extends $SelectIncludeOmit<$Schema, "RatedVideo", true>> = $SimplifiedModelResult<$Schema, "RatedVideo", Args>;
...
export type GalleryGetPayload<Args extends $SelectIncludeOmit<$Schema, "Gallery", true>> = $SimplifiedModelResult<$Schema, "Gallery", Args>;
